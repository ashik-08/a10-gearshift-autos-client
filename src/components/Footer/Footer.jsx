...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-blue-gray-100 mt-32">
      <div className="container mx-auto px-5 pt-20">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <div className="flex gap-2 md:gap-4 mb-6">
            <img
              className="w-10 md:w-12 md:h-10 lg:w-16 lg:h-12"
            ...
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <Typography
                  variant="small"
                  color="blue-gray"
                  className="mb-3 text-base font-charmon font-medium opacity-40"
                >
                  {title}
                </Typography>
                {items.map((link) => (
                  <li key={link}>
                    <Typography
                      ...
                      href="#"
                      color="gray"
                      className="py-1.5 font-annie font-normal transition-colors hover:text-blue-gray-900"
                    >
                      {link}
                    </Typography>
                  </li>
